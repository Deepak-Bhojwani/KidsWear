<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="order.aspx.cs" Inherits="Kid_s_Garment_order" %>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
               ...
               <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="ORDER DATE">
                    <ItemTemplate>
                        <asp:Label ID="date" Width="100px" CssClass="date" Text='<% #Eval("fodate")%>' runat="server"></asp:Label>
                    </ItemTemplate>
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:TemplateField>
